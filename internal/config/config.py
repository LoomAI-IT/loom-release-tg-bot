...
class Config:
    def __init__(self):
        ...
        self.service_name = os.getenv("KONTUR_RELEASE_TG_BOT_CONTAINER_NAME", "kontur-tg-bot")
        self.http_port = os.getenv("KONTUR_RELEASE_TG_BOT_PORT", "8000")
        self.service_version = os.getenv("SERVICE_VERSION", "1.0.0")
        self.root_path = os.getenv("ROOT_PATH", "/")
        self.prefix = os.getenv("KONTUR_RELEASE_TG_BOT_PREFIX", "/api/tg-bot")
        self.log_level = os.getenv("LOG_LEVEL", "INFO")
        self.release_tg_bot_token: str = os.environ.get('KONTUR_RELEASE_TG_BOT_TOKEN')
        self.domain: str = os.environ.get("KONTUR_DOMAIN")

        self.interserver_secret_key = os.getenv("KONTUR_INTERSERVER_SECRET_KEY")

        # PostgreSQL configuration
        self.db_host = os.getenv("KONTUR_RELEASE_TG_BOT_POSTGRES_CONTAINER_NAME", "localhost")
        self.db_port = "5432"
        self.db_name = os.getenv("KONTUR_RELEASE_TG_BOT_POSTGRES_DB_NAME", "hr_interview")
        self.db_user = os.getenv("KONTUR_RELEASE_TG_BOT_POSTGRES_USER", "postgres")
        self.db_pass = os.getenv("KONTUR_RELEASE_TG_BOT_POSTGRES_PASSWORD", "password")
